    ...
    return (
        ...
        <div className="container">
            ...
            <div className="col-5 fs-5 bg-light shadow-lg">
                ...
                <p>Darell Mona</p>
                <p><i className="bi bi-facebook" />  : <a href="https://www.facebook.com/darel.mona.3" target="_blank" rel="noreferrer">Darell Mona</a></p>
                <p><i className="bi bi-whatsapp" />  : +62 899-1661-959</p>
                <p><i className="bi bi-instagram" /> : <a href="https://www.instagram.com/darellyuhu">@darellyuhu</a></p>
            </div>
            </div>
        </div>
